...
;Si es posible, mueve al jugador hacia arriba una cantidad de píxeles igual al número recibido.
...
(define (reset-pos e) (make-estado POS-INICIAL POS-OBJETIVO (- (estado-vidas e) 1) (estado-tiempo e)))
